      ...
      <div className="max-w-[1920px] mx-auto px-4 md:px-10 lg:px-20">
        ...
        <div className="flex flex-col items-center text-center mb-12">
          <div className="flex items-center gap-4 mb-3">
            ...
            <span className="text-[12px] font-bold text-blue-600 tracking-[0.2em] uppercase">Specialized Selection</span>
            <span className="h-px w-8 md:w-12 bg-blue-600" />
          </div>
          <h2 className="text-2xl md:text-4xl font-bold text-slate-900 leading-tight mb-4">
            Professional <span className="text-blue-600">Printers</span>
          </h2>
          <p className="text-slate-500 text-[13px] md:text-[15px] font-medium max-w-2xl leading-relaxed">
            Professional-grade printers engineered for high-volume productivity and precision in corporate environments.
          </p>
        </div>
                ...
                <div className="bg-white border border-slate-200 rounded-xl overflow-hidden flex flex-col h-full">
                  <Link to={`/product/${p.slug}`} className="relative block aspect-square bg-white overflow-hidden p-4 border-b border-slate-100">
                    ...
                    <button 
                      ...
                      className="absolute top-2 right-2 h-8 w-8 rounded-full bg-white shadow-sm border border-slate-100 flex items-center justify-center text-slate-400 hover:text-red-500 transition-colors"
                    >
                  ...
                  <div className="p-3 flex flex-col flex-1">
                    ...
                    <div className="mt-auto pt-3 flex flex-col gap-3">
                      ...
                      <button 
                        ...
                        className="w-full py-2.5 rounded-lg bg-blue-600 text-white text-[12px] font-bold flex items-center justify-center gap-2 hover:bg-slate-900 transition-all active:scale-95 shadow-md shadow-blue-100"
                      >
