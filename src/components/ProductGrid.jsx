  ...
  return (
    <section className="bg-white py-20 md:py-28 w-full overflow-hidden font-jakarta border-t border-gray-50">
      <div className="max-w-[1920px] mx-auto px-6 lg:px-12">
        ...
        {/* --- PRODUCT GRID --- */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-x-8 gap-y-12">
          {products.slice(0, 15).map((p, idx) => (
            ...
            >
              ...
              <div className="relative aspect-[4/5] w-full bg-[#FBFBFA] flex items-center justify-center p-8 overflow-hidden rounded-sm transition-all duration-700 group-hover:bg-[#F5F5F3]">
                ...
                {/* Product Details */}              <div className="pt-6 pb-2 text-center">
        ...
        <div className="mt-20 text-center">
          ...
          >
            Explore Complete Collection <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
          </Link>
        </div>
