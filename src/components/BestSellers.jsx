        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 md:mb-16 gap-6">
          <div className="flex flex-col gap-3">
             <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-black text-slate-400 uppercase tracking-[0.4em]">Top Trending</span>
             </div>
             <div className="flex flex-col gap-2">
                <h2 className="text-3xl md:text-5xl font-black  leading-none">
                  <span className="text-slate-900">Best</span> <span className="text-blue-600 relative">Sellers
                ...
                <p className="text-slate-500 text-sm md:text-base font-medium max-w-lg mt-2 leading-relaxed">
                  Our most popular precision printers, engineered for the highest standards of reliability.
                </p>
             </div>
          </div>

          <div className="flex items-center gap-3">
            <button className="bs-prev h-12 w-12 rounded-full border border-slate-200 flex items-center justify-center text-slate-400 hover:text-blue-600 hover:border-blue-600 hover:bg-blue-50 transition-all shadow-sm active:scale-90">
              <ChevronLeft size={22} strokeWidth={2.5} />
            </button>
            <button className="bs-next h-12 w-12 rounded-full border border-slate-200 flex items-center justify-center text-slate-400 hover:text-blue-600 hover:border-blue-600 hover:bg-blue-50 transition-all shadow-sm active:scale-90">
