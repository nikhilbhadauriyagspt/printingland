...
export default function TermsAndConditions() {
  ...
  ("Company," "we," "us," "our"), a company registered in Minnesota, United States at 1901 S Woodrow St, Little Rock, AR 72204, USA
      </p>
      <p>
        We operate the website <a href="http://Print Ease.shop/">http://Print Ease.shop/</a> (the "Site"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").
      </p>
      <p>
       Print Ease
  ...
  is your trusted destination for authentic, high-performance printers and printing accessories from HP and other leading printing brands.
      ...
      <p>
        You can contact us by email at <a href="mailto:info@printease.shop">info@printease.shop</a>, or by mail to 1901 S Woodrow St, Little Rock, AR 72204, USA
      </p>
      <p>
        These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), andPrint Ease
  ...
  , concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. <strong>IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</strong>
      ...
      <div className="bg-slate-50 p-8 rounded-[2rem] border border-slate-100 my-12 not-prose">
        <h2 className="text-2xl font-black text-slate-900 uppercase mt-0 mb-6 er">TABLE OF CONTENTS</h2>
      ...
      <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <a href="mailto:info@printease.shop">info@printease.shop</a>. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
      ...
      <p>Please review our Return Policy prior to making any purchases: <a href="http://Print Ease.shop/return-policy">http://Print Ease.shop/return-policy</a>.</p>
      ...
      <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 my-8 not-prose">
        <address className="not-italic text-slate-700 font-bold leading-relaxed space-y-2 uppercase er">
          <p className="text-slate-900 font-black">Print Ease </p>
          <p>1901 S Woodrow St, Little Rock, AR 72204, USA</p>
          
          <p className="pt-4 text-blue-600 font-black lowercase">Email: <a href="mailto:info@printease.shop" className="hover:underline">info@printease.shop</a></p>
        </address>
      </div>
    </PolicyLayout>
  );
