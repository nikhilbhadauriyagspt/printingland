...
export default function TermsAndConditions() {
  return (
    ...
    >
      ...
      <p>
        We are Mike's Printer
 
  ("Company," "we," "us," "our"), a company registered in Minnesota, United States at 2453 Hennepin Ave, Minneapolis, MN 55405, USA.
      </p>
      <p>
        We operate the website <a href="http://Mike's Printer.shop/">http://Mike's Printer.shop/</a> (the "Site"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").
      </p>
      <p>
        Mike's Printer
  ...
  is your trusted destination for authentic, high-performance printers and printing accessories from HP and other leading printing brands.
      ...
      <p>
        You can contact us by email at <a href="mailto:info@mikesprinter.shop">info@mikesprinter.shop</a>, or by mail to 2453 Hennepin Ave, Minneapolis, MN 55405, USA.
      </p>
      <p>
        These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and Mike's Printer
  ...
  , concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. <strong>IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</strong>
      ...
      <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <a href="mailto:info@mikesprinter.shop">info@mikesprinter.shop</a>. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
      ...
      <p>Please review our Return Policy prior to making any purchases: <a href="http://Mike's Printer.shop/return-policy">http://Mike's Printer.shop/return-policy</a>.</p>
      ...
      <p>We care about data privacy and security. Please review our Privacy Policy: <a href="http://Mike's Printer.shop/privacy-policy">http://Mike's Printer.shop/privacy-policy</a>. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in the United States. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Services, you are transferring your data to the United States, and you expressly consent to have your data transferred to and processed in the United States.</p>
      ...
      <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 my-8 not-prose">
        <address className="not-italic text-slate-700 font-bold leading-relaxed space-y-2 uppercase tracking-tighter">
          ...
          <p className="pt-4 text-blue-600 font-black lowercase">Email: info@mikesprinter.shop</p>
        </address>
      </div>
    </PolicyLayout>
  );
