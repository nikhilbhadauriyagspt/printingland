...
export default function TermsAndConditions() {
  ...
  ("Company," "we," "us," "our"), a company registered in Minnesota, United States at 2453 Hennepin Ave, Minneapolis, MN 55405, USA.
      ...
      <p>
        We operate the website <a href="http://Lux Printers.shop/">http://Lux Printers.shop/</a> (the "Site"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").
      </p>
      <p>
       Lux Printers
  ...
  is your trusted destination for authentic, high-performance printers and printing accessories from HP and other leading printing brands.
      ...
      <p>
        You can contact us by email at <a href="mailto:info@luxprinters.shop">info@luxprinters.shop</a>, or by mail to 2453 Hennepin Ave, Minneapolis, MN 55405, USA.
      </p>
      <p>
        These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), andLux Printers
  ...
  , concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. <strong>IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</strong>
      ...
      <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <a href="mailto:info@luxprinters.shop">info@luxprinters.shop</a>. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
      ...
      <p>Please review our Return Policy prior to making any purchases: <a href="http://Lux Printers.shop/return-policy">http://Lux Printers.shop/return-policy</a>.</p>
