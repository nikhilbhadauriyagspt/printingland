...
export default function TermsAndConditions() {
  ...
  ("Company," "we," "us," "our"), a company registered in Nanjing, China at Room 402-19, Building A2, No. 9 Kechuang Avenue, Intelligent Manufacturing Industrial Park (Zhigu Park), Jiangbei New Area, Nanjing, Jiangsu (JS), 320500, China
      </p>
      <p>
        We operate the website <a href="http://printingland.shop/">http://printingland.shop/</a> (the "Site"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").
      </p>
      <p>
       Printing Land
  ...
  is your trusted destination for authentic, high-performance printers and printing accessories from HP and other leading printing brands.
      ...
      <p>
        You can contact us by email at <a href="mailto:info@printingland.shop">info@printingland.shop</a>, or by mail to Room 402-19, Building A2, No. 9 Kechuang Avenue, Intelligent Manufacturing Industrial Park (Zhigu Park), Jiangbei New Area, Nanjing, Jiangsu (JS), 320500, China
      </p>
      <p>
        These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), andPrinting Land
  ...
  , concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. <strong>IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</strong>
      ...
      <div className="bg-slate-50 p-8 rounded-[2rem] border border-slate-100 my-12 not-prose">
        <h2 className="text-2xl font-bold text-slate-900 uppercase mt-0 mb-6 er">TABLE OF CONTENTS</h2>
      ...
      <p>Please review our Return Policy prior to making any purchases: <a href="http://printingland.shop/return-policy">http://printingland.shop/return-policy</a>.</p>
      ...
      <p>The Services does not offer users to submit or post content. We may provide you with the opportunity to create, submit, post, display, transmit, perform, publish, distribute, or broadcast content and materials to us or on the Services, including but not limited to text, writings, video, audio, photographs, graphics, comments, suggestions, or personal information or other material (collectively, "Contributions"). Contributions may be viewable by other users of the Services and through third-party websites. As such, any Contributions you transmit may be treated in accordance with the Services' Privacy Policy.</p>
      ...
      <p>These Legal Terms and your use of the Services are governed by and construed in accordance with the laws of the State of Virginia applicable to agreements made and to be entirely performed within the State of Virginia, without regard to its conflict of law principles.</p>

      <h2>16. DISPUTE RESOLUTION</h2>
      <p>Any legal action of whatever nature brought by either you or us (collectively, the "Parties" and individually, a "Party") shall be commenced or prosecuted in the state and federal courts located in Virginia, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction and forum non conveniens with respect to venue and jurisdiction in such state and federal courts.</p>
      ...
      <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 my-8 not-prose">
        <address className="not-italic text-slate-700 font-bold leading-relaxed space-y-2 uppercase er">
          <p className="text-slate-900 font-bold">Nanjing New Channel E-commerce Co., Ltd</p>
          <p>Room 402-19, Building A2, No. 9 Kechuang Avenue, Intelligent Manufacturing Industrial Park (Zhigu Park), Jiangbei New Area, Nanjing, Jiangsu (JS), 320500, China</p>
          
          <p className="pt-4 text-black font-bold lowercase">Email: <a href="mailto:info@printingland.shop" className="hover:underline">info@printingland.shop</a></p>
        </address>
      </div>
    </PolicyLayout>
  );
