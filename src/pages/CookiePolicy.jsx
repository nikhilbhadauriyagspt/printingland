...
export default function CookiePolicy() {
  return (
    ...
    >
      <p className="lead">
        This cookie policy explains howPrinting Land
        ("company," "we," "us," or "our") uses cookies and similar technologies when you visit our website: <a href="https://printingland.shop/">https://printingland.shop/</a>
      </p>
      <p>
      ...
      <ul>
        <li>Emailing: <a href="mailto:info@printingland.shop">info@printingland.shop</a></li>
