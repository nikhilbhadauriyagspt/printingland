...
export default function PrivacyPolicy() {
  return (
    ...
    >
      <p className="lead">
                 This Privacy Notice for Mike's Printer
 
   ("we," "us," or "our"), describes how and why we might access, collect, store, use, and/or share ("process") your personal information when you use our services ("Services"), including when you:      </p>
      <ul>
        <li>Visit our website at <a href="http://Mike's Printer.shop/">http://Mike's Printer.shop/</a> or any website of ours that links to this Privacy Notice</li>
                 <li>Use Printers, Consumables & Accessories. Mike's Printer
  ...
  is your trusted destination for authentic, high-performance printers and printing accessories from HP and other leading printing brands.</li>        <li>Engage with us in other related ways, including any marketing or events</li>
      ...
      <p>
        Questions or concerns? Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a href="mailto:info@mikesprinter.shop">info@mikesprinter.shop</a>.
      </p>
      ...
      <p>Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice: <a href="http://Mike's Printer.shop/cookie-policy">http://Mike's Printer.shop/cookie-policy</a>.</p>
      ...
      <p><strong>Cookies and similar technologies:</strong> Most Web browsers are set to accept cookies by default. If you prefer, you can usually choose to set your browser to remove cookies and to reject cookies. If you choose to remove cookies or reject cookies, this could affect certain features or services of our Services. For further information, please see our Cookie Notice: <a href="http://Mike's Printer.shop/cookie-policy">http://Mike's Printer.shop/cookie-policy</a>.</p>
      <p>If you have questions or comments about your privacy rights, you may email us at <a href="mailto:info@mikesprinter.shop">info@mikesprinter.shop</a>.</p>
        ...
        <table className="w-full text-sm text-left text-slate-500 border border-slate-200">
          ...
          <tbody>
            ...
            <tr className="border-b border-slate-200">
              ...
              <td className="px-6 py-4 border-r border-slate-200">Inferences drawn from any of the collected personal information listed above to create a profile or summary about, for example, an individualâ€™s preferences and characteristics</td>
              <td className="px-6 py-4 text-slate-900 font-black">NO</td>
            </tr>
            <tr>
      ...
      <h3>How to Exercise Your Rights</h3>
             <p>To exercise these rights, you can contact us by submitting a data subject access request, by emailing us at info@mikesprinter.shop, by visiting <a href="http://Mike's Printer.shop/contact">http://Mike's Printer.shop/contact</a>, or by referring to the contact details at the bottom of this document.</p>      <p>Under certain US state data protection laws, you can designate an authorized agent to make a request on your behalf. We may deny a request from an authorized agent that does not submit proof that they have been validly authorized to act on your behalf in accordance with applicable laws.</p>
      ...
      <h3>Appeals</h3>
      <p>Under certain US state data protection laws, if we decline to take action regarding your request, you may appeal our decision by emailing us at <a href="mailto:info@mikesprinter.shop">info@mikesprinter.shop</a>. We will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions. If your appeal is denied, you may submit a complaint to your state attorney general.</p>
      ...
      <p>If you have questions or comments about this notice, you may email us at <a href="mailto:info@mikesprinter.shop">info@mikesprinter.shop</a> or contact us by post at:</p>
      <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 my-8 not-prose">
        <address className="not-italic text-slate-700 font-bold leading-relaxed">
                     Mike's Printer <br/>
                    4100 University Ave, West Des Moines, IA 50266, USA
        </address>
      </div>
