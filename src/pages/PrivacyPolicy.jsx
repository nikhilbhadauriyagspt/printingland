...
export default function PrivacyPolicy() {
  const email = "info@printingland.shop";
  ...
  return (
    ...
    >
      <p className="lead">
        This Privacy Notice forPrinting Land ("we," "us," or "our"), describes how and why we might access, collect, store, use, and/or share ("process") your personal information when you use our services ("Services"), including when you:
      </p>
      <ul>
        <li>Visit our website at <a href="https://printingland.shop/">http://printingland.shop/</a> or any website of ours that links to this Privacy Notice</li>
        <li>Use Printers, Consumables & Accessories.Printing Land is your trusted destination for authentic, high-performance printers and printing accessories from HP and other leading printing brands.</li>
      ...
      <div className="bg-slate-50 p-8 rounded-2xl border border-slate-100 my-12 not-prose">
        <h2 className="text-xl font-bold text-slate-900 mt-0 mb-6">Summary of key points</h2>
      ...
      <h2 className="text-xl font-bold text-slate-900">1. What information do we collect?</h2>
      ...
      <h2 className="text-xl font-bold text-slate-900">2. How do we process your information?</h2>
      ...
      <h2 className="text-xl font-bold text-slate-900">3. What legal bases do we rely on to process your information?</h2>
      ...
      <h2 className="text-xl font-bold text-slate-900">4. When and with whom do we share your personal information?</h2>
      ...
      <h2 className="text-xl font-bold text-slate-900">5. Do we use cookies and other tracking technologies?</h2>
      ...
      <p>Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice: <a href="https://printingland.shop/cookie-policy">https://printingland.shop/cookie-policy</a>.</p>
      ...
      <h2 className="text-xl font-bold text-slate-900">6. How long do we keep your information?</h2>
      ...
      <h2 className="text-xl font-bold text-slate-900">7. How do we keep your information safe?</h2>
      ...
      <h2 className="text-xl font-bold text-slate-900">8. Do we collect information from minors?</h2>
      ...
      <h2 className="text-xl font-bold text-slate-900">9. What are your privacy rights?</h2>
      ...
      <h2 className="text-xl font-bold text-slate-900">11. Do united states residents have specific privacy rights?</h2>
      ...
      <p>To exercise any of these rights, please contact us by {emailLink} or by visiting <a href="https://printingland.shop/contact">https://printingland.shop/contact</a>.</p>
      <h3>Appeals</h3>
      ...
      <h2 className="text-xl font-bold text-slate-900">12. Do we make updates to this notice?</h2>
      ...
      <h2 className="text-xl font-bold text-slate-900">13. How can you contact us about this notice?</h2>
      ...
      <h2 className="text-xl font-bold text-slate-900">14. How can you review, update, or delete the data we collect from you?</h2>
