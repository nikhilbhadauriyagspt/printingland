...
export default function PrivacyPolicy() {
  const email = "info@iconicprinters.shop";
  const emailLink = <a href={`mailto:${email}`} className="hover:underline text-blue-600">{email}</a>;
  ...
  return (
    ...
    >
      <p className="lead">
        This Privacy Notice forIconic Printers ("we," "us," or "our"), describes how and why we might access, collect, store, use, and/or share ("process") your personal information when you use our services ("Services"), including when you:
      </p>
      <ul>
        <li>Visit our website at <a href="https://iconicprinters.shop/">http://iconicprinters.shop/</a> or any website of ours that links to this Privacy Notice</li>
        <li>Use Printers, Consumables & Accessories.Iconic Printers is your trusted destination for authentic, high-performance printers and printing accessories from HP and other leading printing brands.</li>
      ...
      <div className="bg-slate-50 p-8 rounded-2xl border border-slate-100 my-12 not-prose">
        <h2 className="text-xl font-black text-slate-900 mt-0 mb-6">Summary of key points</h2>
        <p className="text-sm text-slate-600 leading-relaxed space-y-4">
          This summary provides key points from our Privacy Notice, but you can find out more details about any of these topics by clicking the link following each key point or by using our table of contents below to find the section you are looking for.
        </p>
        <ul className="text-sm text-slate-600 space-y-4 mt-6 list-disc pl-5">
      ...
      <h2 className="text-xl font-black text-slate-900">Table of contents</h2>
      <ol>
      ...
      <h2 className="text-xl font-black text-slate-900">1. What information do we collect?</h2>
      ...
      <h2 className="text-xl font-black text-slate-900">2. How do we process your information?</h2>
      ...
      <h2 className="text-xl font-black text-slate-900">3. What legal bases do we rely on to process your information?</h2>
      ...
      <h2 className="text-xl font-black text-slate-900">4. When and with whom do we share your personal information?</h2>
      ...
      <h2 className="text-xl font-black text-slate-900">5. Do we use cookies and other tracking technologies?</h2>
      ...
      <p>Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice: <a href="https://iconicprinters.shop/cookie-policy">https://iconicprinters.shop/cookie-policy</a>.</p>
      ...
      <h2 className="text-xl font-black text-slate-900">6. How long do we keep your information?</h2>
      ...
      <h2 className="text-xl font-black text-slate-900">7. How do we keep your information safe?</h2>
      ...
      <h2 className="text-xl font-black text-slate-900">8. Do we collect information from minors?</h2>
      ...
      <h2 className="text-xl font-black text-slate-900">11. Do united states residents have specific privacy rights?</h2>
      ...
      <p>To exercise any of these rights, please contact us by {emailLink} or by visiting <a href="https://iconicprinters.shop/contact">https://iconicprinters.shop/contact</a>.</p>
      <h3>Appeals</h3>
      ...
      <h2 className="text-xl font-black text-slate-900">12. Do we make updates to this notice?</h2>
      ...
      <h2 className="text-xl font-black text-slate-900">13. How can you contact us about this notice?</h2>
      ...
      <h2 className="text-xl font-black text-slate-900">14. How can you review, update, or delete the data we collect from you?</h2>
      <p>Based on the applicable laws of your country or state of residence in the US, you may have the right to request access to the personal information we collect from you, details about how we have processed it, correct inaccuracies, or delete your personal information. You may also have the right to withdraw your consent to our processing of your personal information. These rights may be limited in some circumstances by applicable law. To request to review, update, or delete your personal information, please contact us at {emailLink}.</p>
    </PolicyLayout>
  );
}
