...
export default function PrivacyPolicy() {
  const email = "info@luxprinters.shop";
  ...
  return (
    ...
    >
      ...
      <ul>
        <li>Visit our website at <a href="https://luxprinters.shop/">http://luxprinters.shop/</a> or any website of ours that links to this Privacy Notice</li>
        <li>Use Printers, Consumables & Accessories.Lux Printers is your trusted destination for authentic, high-performance printers and printing accessories from HP and other leading printing brands.</li>
      ...
      <p>Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice: <a href="https://luxprinters.shop/cookie-policy">https://luxprinters.shop/cookie-policy</a>.</p>
      ...
      <p>To exercise any of these rights, please contact us by {emailLink} or by visiting <a href="https://luxprinters.shop/contact">https://luxprinters.shop/contact</a>.</p>
      <h3>Appeals</h3>
