...
export default function PrivacyPolicy() {
  const email = "info@printease.shop";
  ...
  return (
    ...
    >
      <p className="lead">
        This Privacy Notice forPrint Ease ("we," "us," or "our"), describes how and why we might access, collect, store, use, and/or share ("process") your personal information when you use our services ("Services"), including when you:
      </p>
      <ul>
        <li>Visit our website at <a href="https://printease.shop/">http://printease.shop/</a> or any website of ours that links to this Privacy Notice</li>
        <li>Use Printers, Consumables & Accessories.Print Ease is your trusted destination for authentic, high-performance printers and printing accessories from HP and other leading printing brands.</li>
      ...
      <p>Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice: <a href="https://printease.shop/cookie-policy">https://printease.shop/cookie-policy</a>.</p>
      ...
      <p>To exercise any of these rights, please contact us by {emailLink} or by visiting <a href="https://printease.shop/contact">https://printease.shop/contact</a>.</p>
      <h3>Appeals</h3>
      ...
      <div className="bg-slate-50 p-8 rounded-2xl border border-slate-100 my-8 not-prose">
        <address className="not-italic text-slate-700 font-bold leading-relaxed">
         Print Ease <br/>
          1901 S Woodrow St, Little Rock, AR 72204, USA
        </address>
      </div>
