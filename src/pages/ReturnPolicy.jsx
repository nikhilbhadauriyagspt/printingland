...
export default function ReturnPolicy() {
  return (
    ...
    >
      ...
      <p>
                 To return an item, please email customer service at <a href="mailto:info@printingland.shop">info@printingland.shop</a>.      </p>
      ...
      <div className="bg-slate-50 p-8 rounded-none border border-slate-100 my-8 not-prose">
        <address className="not-italic text-slate-700 font-bold leading-relaxed space-y-3">
                     <p className="flex items-center gap-3 text-black font-bold ">info@printingland.shop</p>          <p className="text-[10px] text-slate-400 font-bold uppercase tracking-[0.2em]">Contact support for immediate assistance</p>
        </address>
      </div>
    </PolicyLayout>
  );
