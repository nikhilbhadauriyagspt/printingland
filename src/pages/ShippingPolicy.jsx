...
export default function ShippingPolicy() {
  return (
    ...
    >
      ...
      <p>
        If you have questions about returns, please review our return policy: <Link to="/return-policy">https://luxprinters.shop/return-policy</Link>.
      </p>
      ...
      <div className="bg-gray-50 p-8 rounded-xl border border-gray-100 my-8 not-prose">
        <address className="not-italic text-slate-700 font-bold leading-relaxed space-y-3">
          <p className="flex items-center gap-3 text-blue-600 font-bold ">Email: <a href="mailto:info@luxprinters.shop" className="hover:underline">info@luxprinters.shop</a></p>
